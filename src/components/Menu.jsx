...
function Menu() {
  ...
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav className="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 lg:rounded-full not-lg:rounded-2xl mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
        <div className="px-4 md:px-0 flex justify-between items-center">
          ...
          <div className="md:hidden">
            ...
            >
              <svg
                className={`${showMenu ? "" : "hidden"} shrink-0 size-3.5`}
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              <svg
                className={`${showMenu ? "hidden" : ""} shrink-0 size-4`}
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div
          ...
          className={`${showMenu ? "hidden" : ""} hs-collapse overflow-hidden transition-all duration-300 basis-full grow md:block`}
        >
